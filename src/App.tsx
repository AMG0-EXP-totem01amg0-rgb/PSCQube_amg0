...
export default function App() {
  ...
  const selectedPalletizer = useMemo(() => 
    masters.palletizers.find(p => p.id === userContext.selectedPalletizerId) || 
    masters.baggers.find(b => b.id === userContext.selectedPalletizerId) || null,
    [masters.palletizers, masters.baggers, userContext.selectedPalletizerId]
  );
  ...
  return (
    <>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Header 
            palletizers={[...masters.palletizers, ...masters.baggers]}

...
<<<<<<< HEAD
                      ...
                      activeSection === section.id 
                        ...
                        : isDark
                          ? "bg-slate-800 text-white border-slate-700/80 group-hover:bg-slate-700 group-hover:text-white group-hover:border-slate-500 group-hover:scale-105 active:scale-95"
                          : "bg-slate-100 text-slate-900 border-slate-300 group-hover:bg-slate-200 group-hover:text-primary group-hover:border-slate-400 group-hover:scale-105 active:scale-95"
                    )}>
                      {React.cloneElement(section.icon as React.ReactElement, { size: 20 })}
                    </div>
                    <span className={cn(
                      "text-[8px] uppercase tracking-wider text-center transition-colors px-1",
                      activeSection === section.id 

    ...
    <div className="flex items-center justify-end gap-2">
      {onEdit && (
        <button 
          ...
          className="p-2 rounded-xl bg-blue-500/20 text-blue-400 dark:text-blue-300 hover:bg-blue-600 hover:text-white transition-all active:scale-95 border border-blue-500/40 shadow-xs group"
          title="Editar"
        >
